...
| `cond_est` | Оценка числа обусловленности (пусто если n > 10000 или ошибка) |
...
**Число обусловленности** — вычисляется через LAPACK `dgecon` (dense LU) только для матриц n ≤ 10000. Для больших матриц поле остаётся пустым.
